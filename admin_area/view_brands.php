...
<table class="table table-bordered mt-5">
    ...
    <tbody class="bg-secondary text-light">
        ...
        <tr class="text-center">
            ...
            <td><a href='index.php?edit_brands=<?php echo $brand_id ?>' class='text-light'><img src="./product_images/adminlogin.jpg" alt="" class="temp_img"></a></td>
            <td><a href='index.php?delete_brands=<?php echo $brand_id ?>' type="button" class="text-light" data-bs-toggle="modal" data-bs-target="#exampleModal"><img src="./product_images/biryani1.jpg" alt="" class="temp_img"></a></td>
        </tr>
        <?php
        }
        ?>
